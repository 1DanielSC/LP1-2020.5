...
Seguranca::Seguranca(std::string nome, int idade, std::string setorResponsavel, std::string turno)
	:Funcionario{nome, idade}, SetorResponsavel{setorResponsavel}, Turno{turno} {}

void Seguranca::setSetorResponsavel(std::string setor) {this->SetorResponsavel = setorResponsavel;}
